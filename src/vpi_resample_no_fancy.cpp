...
#include "airlab_ros_common/string_common.hpp"
...
int main(int argc, char** argv) {
    ...
    GET_PARAM_DEFAULT(std::string, test_data_dir, "./data", nh_private_)
    GET_PARAM_DEFAULT(std::string, test_output_dir, "./test_output", nh_private_)
    ...
    // const std::string in_img_0_fn = "/data/home/airlab/ROS/dsta_ord_vpi_stereo/src/dsta_vpi_resample_fisheye/data/cam0.png";
    // const std::string in_img_1_fn = "/data/home/airlab/ROS/dsta_ord_vpi_stereo/src/dsta_vpi_resample_fisheye/data/cam1.png";
    // const std::string calib_fn = "/data/home/airlab/ROS/dsta_ord_vpi_stereo/src/dsta_vpi_resample_fisheye/calib/dsta_ord_eval_20220408.yaml";
    // const std::string test_output_dir = "/data/home/airlab/ROS/dsta_ord_vpi_stereo/src/dsta_vpi_resample_fisheye/test_output";
    ...
    const std::string in_img_0_fn = test_data_dir + "/cam0.png";
    const std::string in_img_1_fn = test_data_dir + "/cam1.png";
    ...
    std::string test_output_fn = test_output_dir + "/pinhole_0.png";
    cv::imwrite(test_output_fn, out_ocv_0);
    test_output_fn = test_output_dir + "/pinhole_1.png";
    cv::imwrite(test_output_fn, out_ocv_1);
